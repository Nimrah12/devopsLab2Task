...
echo Nimrah Memon >> README.md
echo "[devops-lab-2](https://github.com/Nimrah12/devopsLab2Task)" >> README.md
echo --- >> README.md
...
git remote add origin https://github.com/Nimrah12/devopsLab2Task.git
git branch -M main
